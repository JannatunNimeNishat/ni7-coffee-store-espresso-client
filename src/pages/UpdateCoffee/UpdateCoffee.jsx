...
const UpdateCoffee = () => {
    ...
    const { _id, category, chef, details, name, photo, supplier, test } = coffee;
    const initialValues = {
        name: name,
        chef: chef,
        supplier: supplier,
    ...
    const { values, error, handleBlur, handleChange, handleSubmit } = useFormik({
        ...
        onSubmit: (values, action) => {
            ...
            const updatedCoffee = { name, chef, supplier, test, category, details, photo };
            ...
            <div className='my-container pt-5 mb-3'>
                ...
                <div className='bg-[#F4F3F0] pt-3 px-5 py-5 '>
                    <div className='px-20 text-center'>
                        <h3 className='text-3xl mt-5'>Update Existing Coffee Details</h3>
